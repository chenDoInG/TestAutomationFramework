...
public class TicTacToeTest {
    ...
    @Test
    /* The test for the path Initial0 start Started new NewGame moves OWin exit FinalState0  */ 
    public void test2(){
        /*** test code of startMapping for the element start ***/
        //board values
        int[][] Amap = { {0,0,0} , {0,0,0} , {0,0,0}  }; //Available Spots on the board
    ...
    @Test
    /* The test for the path Initial0 start Started new NewGame moves XWin new NewGame moves Draw exit FinalState0  */ 
    public void test4(){
        /*** test code of startMapping for the element start ***/
        //board values
        int[][] Amap = { {0,0,0} , {0,0,0} , {0,0,0}  }; //Available Spots on the board
