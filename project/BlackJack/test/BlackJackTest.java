...
public class BlackJackTest {
    ...
    @Test
    /* The test for the path Initial0 initialize Initialized deal NewDeal stayHitHit AfterStayHitHit  Result  FinalState0  */ 
    public void test0(){
    ...
    @Test
    /* The test for the path Initial0 initialize Initialized deal NewDeal stayStayStay AfterStayStayStay  Result again Initialized deal NewDeal stayHitHit AfterStayHitHit  Result  FinalState0  */ 
    public void test6(){
        /*** test code of initializeMapping for the element initialize ***/
        BlackjackGUI frame = new BlackjackGUI();
        frame.display();
