...
public class ATMTest {
    ...
    @Test
    /* The test for the path Initial0 initialize Idle authenticate AuthenticationValid Inquire BalanceInquired  Idle authenticate AuthenticationNotValid  Idle authenticate AuthenticationNotValid  Idle authenticate AuthenticationValid withdraw Withdrawn  FinalState0  */ 
    public void test0(){
    ...
    @Test
    /* The test for the path Initial0 initialize Idle authenticate AuthenticationValid deposit Deposited  Idle authenticate AuthenticationValid deposit Deposited  Idle authenticate AuthenticationNotValid  FinalState0  */ 
    public void test1(){
        /*** test code of initializeMapping for the element initialize ***/
        boolean userAuthenticated = false; // user is not authenticated to start
        int currentAccountNumber = 0; // no current account number to start
    ...
    @Test
    /* The test for the path Initial0 initialize Idle authenticate AuthenticationValid Inquire BalanceInquired  Idle authenticate AuthenticationValid withdraw Withdrawn  Idle authenticate AuthenticationNotValid  FinalState0  */ 
    public void test2(){
        /*** test code of initializeMapping for the element initialize ***/
        boolean userAuthenticated = false; // user is not authenticated to start
        int currentAccountNumber = 0; // no current account number to start
    ...
    @Test
    /* The test for the path Initial0 initialize Idle authenticate AuthenticationValid withdraw Withdrawn  Idle authenticate AuthenticationValid withdraw Withdrawn  FinalState0  */ 
    public void test5(){
        /*** test code of initializeMapping for the element initialize ***/
        boolean userAuthenticated = false; // user is not authenticated to start
        int currentAccountNumber = 0; // no current account number to start
