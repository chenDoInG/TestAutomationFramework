...
public class ChessTest {
    ...
    @Test
    /* The test for the path Initial initialize NewGame  UndoAllowed checkmate CheckmateUndoAllowed  FinalState  */ 
    public void test1(){
        /*** test code of initializeMapping for the element initialize ***/
        GameController gc = new GameController();
        final ChessBoard chessBoard = gc.getChessBoard();
    ...
    @Test
    /* The test for the path Initial initialize NewGame  UndoAllowed newGame NewGame disallowUndo UndoNotallowed check CheckedUndoNotAllowed checkmateAfterChecked CheckmateUndoNotAllowed newGame NewGame  UndoAllowed checkmate CheckmateUndoAllowed  FinalState  */ 
    public void test2(){
        /*** test code of initializeMapping for the element initialize ***/
        GameController gc = new GameController();
        final ChessBoard chessBoard = gc.getChessBoard();
    ...
    @Test
    /* The test for the path Initial initialize NewGame  UndoAllowed check CheckedUndoAllowed checkmateAfterChecked CheckmateUndoAllowed newGame NewGame disallowUndo UndoNotallowed newGame NewGame  UndoAllowed checkmate CheckmateUndoAllowed  FinalState  */ 
    public void test3(){
        /*** test code of initializeMapping for the element initialize ***/
        GameController gc = new GameController();
        final ChessBoard chessBoard = gc.getChessBoard();
